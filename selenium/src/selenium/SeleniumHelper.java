...
public abstract class SeleniumHelper {
	...
	protected static Logger log = Logger.getLogger(SeleniumHelper.class.getName());
	 ...
	 * 
	 * @param driver
	 * @param nameOrHandle (which got from driver.getWindowHandle())
	 */
	 ...
	 * 
	 * @param driver
	 * @param by identifier of the field to which data has to be pasted
	 */
	 ...
	 * 
	 * @param milliSecs num of milli secs
	 */
	...
	public static boolean waitForWebElementVisible(WebDriver driver, By by, long... waitTime) {
		...
		while (System.currentTimeMillis() < end) {
			try {
				...
				// might be element is not attached to the page document, wait for it to load
				continue;
				// Base exception
			} catch (Exception e) {
				continue;
	...
	public static void waitForElementHasStoppedMoving(WebDriver driver, By by) {
		...
		try {
			...
			log.info("failed while waiting for element to stop moving");
		}
	}
	 ...
	 * 
	 * @param by id, class, name or xpath of the web element on which the javascript should get execute
	 * @param javascript ex: <b>arguments[0].innerHTML="hello world"</b>
	 * @return WebElement Or null (if the javascript has a return value. i.e., if the script deosn't contains a return statement)
	 * 
	 */
	 ...
	 * 
	 * @param javascript ex: <b>return document.readyState</b>
	 * @return WebElement Or null (if the javascript has a return value. i.e., if the script deosn't contains a return statement)
	 * 
	 */
